            ...
            if (this.howl && this.howl._sounds.length > 0) {
                ...
                if (node) {
                    ...
                    if (!node._source) {
                        ...
                        masterGain.gain.value = 0.75;  // Headroom after processing
