    ...
    while True:
        try:
            ...
            cmd = [
                ...
                '-ac', '2',
                '-ar', '44100',
                '-af', 'highpass=f=40,equalizer=f=60:width_type=o:width=2:g=7,equalizer=f=1000:width_type=o:width=2:g=-2,equalizer=f=8000:width_type=o:width=2:g=7,acompressor=threshold=-12dB:ratio=2:attack=50:release=50',
                '-loglevel', 'error',
                'pipe:1'
            ]
